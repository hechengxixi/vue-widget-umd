...
config.output.library = appPackageJson.name; 
...
config.optimization.splitChunks = {
  ...
  name: false,
  cacheGroups: {
      default: false, // disable split chunk
      commons: {
        test: /[\\/]node_modules[\\/]/,
        priority: 1,
        ...
        name(){
          return `${appPackageJson.name}-commons`;
        },
        filename: '[name].js',
        minChunks: 1,
      },
...
function build(previousFileSizes) {
  console.log('Creating a lib build...');

  const compiler = webpack([uncompressedConfig, prodConfig]);
